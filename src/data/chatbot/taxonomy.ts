...
export const CONCERN_SYNONYMS: Record<Concern, string[]> = {
  dryness: [
    ...
    "rough",
    "parched",
    // Bangla script — the normaliser keeps U+0980–U+09FF now
    "শুষ্ক",
    "শুকনো",
    "খসখসে",
    "ড্রাই",
...
export const SKIN_TYPE_SYNONYMS: Record<SkinType, string[]> = {
  dry: ["dry skin", "my skin is dry", "dry type", "শুষ্ক ত্বক", "ড্রাই স্কিন"],
  oily: [
    "oily skin",
    "my skin is oily",
    "oily type",
  ...
  normal: ["normal skin", "normal type", "স্বাভাবিক ত্বক"],
  sensitive: [
    "sensitive skin",
    "reactive skin",
    "easily irritated",
...
export const CATEGORY_SYNONYMS: Record<CategorySlug, string[]> = {
  ...
  serum: ["serum", "serums", "vitamin c serum", "brightening serum", "সিরাম"],
  ...
  toner: ["toner", "toners", "toner pad", "টোনার"],
};
